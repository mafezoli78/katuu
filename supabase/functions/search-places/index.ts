...
class FoursquareProvider implements PlaceProvider {
  ...
  async search(params: SearchParams): Promise<StandardPlace[]> {
    ...
    fsqUrl.searchParams.set("fields", "fsq_place_id,name,latitude,longitude,location,categories");
...
// Geoapify já filtra no servidor dela, ao contrário do Foursquare (que exigia
// curadoria pós-fetch via ALLOWED/EXCLUDED_CATEGORY_IDS acima).
